...
% layer = importKerasLayers(h5_file_path, 'ImportWeights', true); %load model weights
...
% replace = regressionLayer('Name', 'replaced_multlply_OuptLayer');
% replace_layer = replaceLayer(layer,'multiply_OutputLayer_PLACEHOLDER', replace);
